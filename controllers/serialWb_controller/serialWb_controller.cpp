...
int main(int argc, char** argv) {
    ...
    qpoasesInterfaceSimple mpcCal(10,4,4,0,2);// qpOASES simple
    ...
    while (robot->step(timeStep) != -1) {
        ...
        while (key > 0)
        {
            ...
            case 'Z': target_length = 0.18f; break;
            case 'X': target_length = 0.22f; break;
            case 'C': target_length = 0.28f; break;
            case 'V': target_length = 0.34f; break;
